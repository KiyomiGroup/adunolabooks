...
/* Sprint 3: getStoryBySlug() reads from Supabase; chapters from a related table */
      ...
      <main>
          ...
          <div className="container">
            ...
            <div className="book-hero fade-up">
              ...
              <div>
                ...
                {/* Reading stats placeholders — Sprint 3: real analytics */}
        ...
        <section style={{ background: "#FFFFFF", padding: "4rem 0 6rem" }}>
          <div className="container">
            ...
            <h2 className="section-h2 font-display" style={{ marginBottom: "1.5rem" }}>
              Chapters
            </h2>
