  ...
  return (
    <Link href={`/stories/${story.slug}`} className="story-card">
      ...
      <div className="story-card-body">
        <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.55rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--muted)", marginTop: "1rem", marginBottom: "0.75rem" }}>
          {story.genre}
        </p>
        <h3 className="font-display" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem", fontWeight: 400, color: "var(--ink)", lineHeight: 1.25, marginBottom: "0.65rem" }}>
          {story.title}
        </h3>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid var(--lavender-border)", paddingTop: "1rem" }}>
        ...
        {firstChapter && (
          <span style={{ marginTop: "1rem", fontSize: "0.72rem", fontWeight: 500, color: "var(--purple)", letterSpacing: "0.04em" }}>
